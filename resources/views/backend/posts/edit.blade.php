            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit Post</h4><hr>
                        ...
                        <form action="{{ route('posts.update', $post->id) }}" method="post"  enctype="multipart/form-data">
                           ...
                           <input type="hidden" name="id" value="{{ $post->id }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input class="form-control" name="published_at" value="{{ $post->published_at }}"
                            ...
                            <input type="submit" value="Update Post" class="btn btn-info waves-effect waves-light">
                        </form>
                    </div>
                </div>
            </div> <!-- end col -->
